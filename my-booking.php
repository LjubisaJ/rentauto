...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Od dana:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Do dana:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
                <?php if($result->Status==1)
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Odobreno</a>
                           <div class="clearfix"></div>
        </div>

              <?php } else if($result->Status==2) { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Odbijeno</a>
            <div class="clearfix"></div>
        </div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Jos uvek nije odobreno</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
