			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Izmeni automobil</h2>
...
<label class="col-sm-2 control-label">Naziv automobila<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">Izaberi model<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Opis automobila<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Cena po danu(dinar)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Izaberi tip goriva<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Godina proizvodnje<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->ModelYear);?>" required>
</div>
<label class="col-sm-2 control-label">Broj sedista<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Promeni prvu sliku</a>
</div>
<div class="col-sm-4">
Slika 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Promeni drugu sliku</a>
</div>
<div class="col-sm-4">
Slika 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Promeni trecu sliku</a>
</div>
</div>
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Promeni cetvrtu sliku</a>
</div>
<div class="col-sm-4">
Slika 5
<?php if($result->Vimage5=="")
{
echo htmlentities("Slika ne postoji");
} else {?>
<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage5);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Promeni petu sliku</a>
<?php } ?>
</div>
...
<label for="inlineCheckbox1">Klima uredjaj</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Elektricna brava</label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3">Sistem za blokiranje kocnica</label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1">Servo</label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Vazdusni jastuk za vozaca</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3">Putnicki vazdusni jastuk</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3">Elektricni prozori</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1">CD plejer</label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Centralno zakljucavanje</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3">Senzor za sudar</label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3">Kozna sedista</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Sacuvaj promene</button>
												</div>
											</div>
