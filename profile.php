    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Osnovni podaci</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>USPESNO</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">Datum i vreme registracije: </label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label">Poslednje promene izvrsene: </label>
            ...
            <div class="form-group">
              <label class="control-label">Datum rodjenja: &nbsp;(dan/mesec/godina)</label>
              <input class="form-control white_bg" value="<?php echo htmlentities($result->dob);?>" name="dob" placeholder="dan/mesec/godina" id="birth-date" type="text" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Sacuvaj promene<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
