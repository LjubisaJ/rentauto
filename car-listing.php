...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> pronadjenih automobila</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price"><?php echo htmlentities($result->PricePerDay);?> dinara po danu</p>
            <ul>
...
<option value="Plin">Plin</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i>Pretrazi automobil</button>
              </div>
            </form>
          </div>
        </div>
